...
public class AgendaDeConsultas {
    ...
    public DadosDetalhamentoConsulta agendarConsulta(DadosAgendamentosConsulta dados) {
        ...
        if (medico == null) {
            throw new ValidacaoException("Não foi possível encontrar um médico disponível nesta data");
        }
